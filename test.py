...
selection = st.multiselect('Select', [{BMI: "BMI", "short_name": "SN", "some_other_attr": "Name"}, {"name": "Other Name", "short_name": "ON", "some_other_attr": "Other"}], format_func=lambda opt: opt['name'])
st.write(selection)
